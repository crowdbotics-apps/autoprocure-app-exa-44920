"""
Django settings for autoprocure_app_exa_44920 project.
...
ROOT_URLCONF = 'autoprocure_app_exa_44920.urls'
...
WSGI_APPLICATION = 'autoprocure_app_exa_44920.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "autoprocure_app_exa_44920 API",
    "DESCRIPTION": "API documentation for autoprocure_app_exa_44920 App",
    "VERSION": "v1",
}
